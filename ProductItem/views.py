...
class ProductView(View):
    def get(self, request):
        ...
        for category in categories:
            ...
            page_number = request.GET.get(f'{category}_page')  # Page query parameter per category
            paginated_products[category] = paginator.get_page(page_number)
...
class MachineryView(View):
    def get(self, request):
        ...
        paginator = Paginator(machines, 6)  # Show 6 machines per page
